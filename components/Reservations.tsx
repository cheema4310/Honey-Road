...
export const Reservations: React.FC = () => {
  return (
    <section
      id="reservations"
      className="relative py-32 flex items-center justify-center bg-[#1A1A1B] overflow-hidden"
    >
        ...
        <Reveal>
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/3 flex flex-col">
              <GlassCard
                className="flex-1 flex flex-col justify-center items-center text-center py-12 px-6 border-white/10 bg-[#1A1A1B]/60 backdrop-blur-md"
                spotlight
              >
                <div className="w-16 h-16 rounded-full bg-pink-500/10 flex items-center justify-center mb-8">
                  <Calendar className="w-8 h-8 text-pink-500" />
                </div>
                <h2 className="font-serif text-4xl text-white mb-4 tracking-tighter">
                  Reservations
                </h2>
                <p className="text-slate-400 mb-10 max-w-xs text-sm leading-relaxed mx-auto">
                  We recommend booking in advance, especially for weekend
                  dining.
                </p>
                <a
            ...
            <div className="w-full lg:w-2/3 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <GlassCard
                  className="flex flex-col gap-1 border-white/10 py-8 px-8 bg-[#1A1A1B]/60"
                  spotlight
                >
                  ...
                  <h3 className="font-serif text-white text-xl tracking-tight">
                    156 Church Street
                  </h3>
